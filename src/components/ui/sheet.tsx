...
/**
 * LISTINGBUG SHEET SIZE STANDARDS
 * 
 ...
 * 
 * Example: className="w-full sm:max-w-3xl"
 */
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "right" &&
            "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 right-0 h-full w-[calc(100%-12px)] sm:w-full border-l sm:max-w-2xl lg:max-w-4xl",
          side === "left" &&
            "data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left inset-y-0 left-0 h-full w-[calc(100%-12px)] sm:w-full border-r sm:max-w-2xl lg:max-w-4xl",
          side === "top" &&
