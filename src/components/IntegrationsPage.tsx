                ...
                <div className="space-y-2 bg-gray-50 dark:bg-[#1a1a1a] rounded-lg p-3">
                  ...
                  <div className="flex items-center justify-between text-sm py-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[#342e37] dark:text-white font-medium">email</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between text-sm py-1">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <ArrowRight className="w-3 h-3 text-gray-400" />
                      <span className="text-[#342e37] dark:text-white font-medium">FNAME</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between text-sm py-1">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <ArrowRight className="w-3 h-3 text-gray-400" />
                      <span className="text-[#342e37] dark:text-white font-medium">LNAME</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between text-sm py-1">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <ArrowRight className="w-3 h-3 text-gray-400" />
                      <span className="text-[#342e37] dark:text-white font-medium">PHONE</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between text-sm py-1">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <ArrowRight className="w-3 h-3 text-gray-400" />
                      <span className="text-[#342e37] dark:text-white font-medium">ADDRESS</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between text-sm py-1">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <ArrowRight className="w-3 h-3 text-gray-400" />
                      <span className="text-[#342e37] dark:text-white font-medium">PROPERTY_TYPE</span>
                    </div>
                  </div>
                </div>
