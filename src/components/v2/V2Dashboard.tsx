    ...
    <div className="min-h-screen bg-white dark:bg-[#0f0f0f]">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 pt-6">
        ...
        <div className="flex gap-2 md:gap-3 mb-1">
          <div className="flex-1 border-2 border-amber-200 dark:border-amber-900 hover:border-amber-300 dark:hover:border-amber-700 rounded-lg bg-white dark:bg-[#2F2F2F] p-3 md:p-4 flex flex-col items-center" style={{ opacity: statOpacity, transition: 'opacity 0.5s ease, border-color 0.15s ease' }}>
