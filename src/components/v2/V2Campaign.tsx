...
export function V2Campaign() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-[#0f0f0f] relative flex items-center justify-center">
        ...
        <div
          className="w-8 h-8 rounded-full border-2 border-t-transparent animate-spin relative z-10"
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-[#0f0f0f] relative flex items-center justify-center">
        ...
        <div className="text-center px-4 relative z-10">
          ...
          <a href="/v2/dashboard" className="text-xs text-blue-600 dark:text-blue-400 hover:underline">
            ← Back to dashboard
          </a>
        </div>
      </div>
  ...
  const rowInputClass = 'text-[13px] text-gray-900 dark:text-white font-medium text-right bg-transparent dark:bg-[#2a2a2a] border border-transparent hover:border-gray-200 dark:hover:border-white/20 focus:border-[#FFCE0A] dark:focus:border-[#FFCE0A] rounded-md px-2 py-1 outline-none transition-colors leading-none';
