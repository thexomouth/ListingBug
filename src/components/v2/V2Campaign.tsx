...
export function V2Campaign() {
  ...
  const rowInputClass = 'text-xs text-gray-900 dark:text-white font-medium text-right bg-transparent dark:bg-[#2a2a2a] border border-transparent hover:border-gray-200 dark:hover:border-white/20 focus:border-[#FFCE0A] dark:focus:border-[#FFCE0A] rounded-md px-2 py-1 outline-none transition-colors leading-none';
