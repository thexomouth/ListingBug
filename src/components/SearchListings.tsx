  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const finalResults = fetchedResults.map((l: any, i: number) => ({
        ...
        agentName: l.agent?.name || l.agentName || '',
        agentPhone: l.agent?.phone || l.agentPhone || '',
        agentEmail: l.agent?.email || l.agentEmail || '',
        brokerage: l.agent?.office || l.officeName || l.brokerName || '',
        reList: false,
