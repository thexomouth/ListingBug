        ...
        <div className="space-y-4 pb-[100px]">
          {searchHistory.length === 0 ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between"><h3 className="font-bold text-[18px] text-gray-900 dark:text-white">Recent Searches ({searchHistory.length})</h3><span className="hidden md:block"><LBButton variant="outline" size="sm" onClick={() => { setSearchHistory([]); toast.success('Search history cleared'); }}><Trash2 className="w-3.5 h-3.5 mr-1.5" />Clear</LBButton></span></div>
