  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const finalResults = fetchedResults.map((l: any, i: number) => ({
        ...
        agentName: l.agent?.name || l.listingAgent?.name || l.agentName || l.listAgentName || '',
        agentPhone: l.agent?.phone || l.listingAgent?.phone || l.agentPhone || l.listAgentPhone || '',
        agentEmail: l.agent?.email || l.listingAgent?.email || l.agentEmail || l.listAgentEmail || '',
        brokerage: l.agent?.office || l.listingAgent?.office || l.officeName || l.listOfficeName || l.brokerName || '',
        reList: false,
        ...
        <div className="space-y-4">
          {searchHistory.length === 0 && reportHistory.length === 0 ? (
            <div className="text-center py-12 border border-dashed border-gray-300 dark:border-white/20 rounded-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-2 font-medium">No searches yet</p>
